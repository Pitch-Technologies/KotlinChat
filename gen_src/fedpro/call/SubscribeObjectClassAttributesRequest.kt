...
// Source: fedpro.SubscribeObjectClassAttributesRequest in RtiAmbassador.proto
package fedpro.call
...
public class SubscribeObjectClassAttributesRequest(
  @field:WireField(
    tag = 1,
...
) : Message<SubscribeObjectClassAttributesRequest, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is SubscribeObjectClassAttributesRequest) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "SubscribeObjectClassAttributesRequest{", separator = ", ",
        postfix = "}")
  }
  ...
  ): SubscribeObjectClassAttributesRequest = SubscribeObjectClassAttributesRequest(theClass,
      attributeList, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<SubscribeObjectClassAttributesRequest> = object :
        ProtoAdapter<SubscribeObjectClassAttributesRequest>(
      FieldEncoding.LENGTH_DELIMITED, 
      SubscribeObjectClassAttributesRequest::class, 
      "type.googleapis.com/fedpro.SubscribeObjectClassAttributesRequest", 
      PROTO_3, 
      null, 
      "RtiAmbassador.proto"
    ) {
      override fun encodedSize(`value`: SubscribeObjectClassAttributesRequest): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: SubscribeObjectClassAttributesRequest) {
      ...
      override fun decode(reader: ProtoReader): SubscribeObjectClassAttributesRequest {
        ...
        return SubscribeObjectClassAttributesRequest(
          theClass = theClass,
      ...
      override fun redact(`value`: SubscribeObjectClassAttributesRequest):
          SubscribeObjectClassAttributesRequest = value.copy(
