...
// Source: fedpro.RegisterObjectInstanceWithRegionsRequest in RtiAmbassador.proto
package fedpro.call
...
public class RegisterObjectInstanceWithRegionsRequest(
  @field:WireField(
    tag = 1,
...
) : Message<RegisterObjectInstanceWithRegionsRequest, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is RegisterObjectInstanceWithRegionsRequest) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "RegisterObjectInstanceWithRegionsRequest{", separator =
        ", ", postfix = "}")
  }
  ...
  ): RegisterObjectInstanceWithRegionsRequest = RegisterObjectInstanceWithRegionsRequest(theClass,
      attributesAndRegions, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<RegisterObjectInstanceWithRegionsRequest> = object :
        ProtoAdapter<RegisterObjectInstanceWithRegionsRequest>(
      FieldEncoding.LENGTH_DELIMITED, 
      RegisterObjectInstanceWithRegionsRequest::class, 
      "type.googleapis.com/fedpro.RegisterObjectInstanceWithRegionsRequest", 
      PROTO_3, 
      null, 
      "RtiAmbassador.proto"
    ) {
      override fun encodedSize(`value`: RegisterObjectInstanceWithRegionsRequest): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: RegisterObjectInstanceWithRegionsRequest) {
      ...
      override fun decode(reader: ProtoReader): RegisterObjectInstanceWithRegionsRequest {
        ...
        return RegisterObjectInstanceWithRegionsRequest(
          theClass = theClass,
      ...
      override fun redact(`value`: RegisterObjectInstanceWithRegionsRequest):
          RegisterObjectInstanceWithRegionsRequest = value.copy(
