...
// Source: fedpro.SubscribeObjectClassAttributesWithRateRequest in RtiAmbassador.proto
package fedpro.call
...
public class SubscribeObjectClassAttributesWithRateRequest(
  @field:WireField(
    tag = 1,
...
) : Message<SubscribeObjectClassAttributesWithRateRequest, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is SubscribeObjectClassAttributesWithRateRequest) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "SubscribeObjectClassAttributesWithRateRequest{", separator
        = ", ", postfix = "}")
  }
  ...
  public fun copy(
    ...
    unknownFields: ByteString = this.unknownFields,
      ...
      SubscribeObjectClassAttributesWithRateRequest(theClass, attributeList, updateRateDesignator,
      unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<SubscribeObjectClassAttributesWithRateRequest> = object :
        ProtoAdapter<SubscribeObjectClassAttributesWithRateRequest>(
      FieldEncoding.LENGTH_DELIMITED, 
      SubscribeObjectClassAttributesWithRateRequest::class, 
      "type.googleapis.com/fedpro.SubscribeObjectClassAttributesWithRateRequest", 
      PROTO_3, 
      null, 
      "RtiAmbassador.proto"
    ) {
      override fun encodedSize(`value`: SubscribeObjectClassAttributesWithRateRequest): Int {
      ...
      override fun decode(reader: ProtoReader): SubscribeObjectClassAttributesWithRateRequest {
        ...
        return SubscribeObjectClassAttributesWithRateRequest(
          theClass = theClass,
      ...
      override fun redact(`value`: SubscribeObjectClassAttributesWithRateRequest):
          SubscribeObjectClassAttributesWithRateRequest = value.copy(
