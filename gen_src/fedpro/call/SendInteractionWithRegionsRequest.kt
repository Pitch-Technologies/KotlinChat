...
// Source: fedpro.SendInteractionWithRegionsRequest in RtiAmbassador.proto
package fedpro.call
...
public class SendInteractionWithRegionsRequest(
  @field:WireField(
    tag = 1,
...
) : Message<SendInteractionWithRegionsRequest, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is SendInteractionWithRegionsRequest) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "SendInteractionWithRegionsRequest{", separator = ", ",
        postfix = "}")
  }
  ...
  ): SendInteractionWithRegionsRequest = SendInteractionWithRegionsRequest(theInteraction,
      theParameters, regions, userSuppliedTag, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<SendInteractionWithRegionsRequest> = object :
        ProtoAdapter<SendInteractionWithRegionsRequest>(
      FieldEncoding.LENGTH_DELIMITED, 
      SendInteractionWithRegionsRequest::class, 
      "type.googleapis.com/fedpro.SendInteractionWithRegionsRequest", 
      PROTO_3, 
      null, 
      "RtiAmbassador.proto"
    ) {
      override fun encodedSize(`value`: SendInteractionWithRegionsRequest): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: SendInteractionWithRegionsRequest) {
      ...
      override fun encode(writer: ReverseProtoWriter, `value`: SendInteractionWithRegionsRequest) {
        writer.writeBytes(value.unknownFields)
        if (value.userSuppliedTag != ByteString.EMPTY) ProtoAdapter.BYTES.encodeWithTag(writer, 4,
            value.userSuppliedTag)
        if (value.regions != null) RegionHandleSet.ADAPTER.encodeWithTag(writer, 3, value.regions)
      ...
      override fun decode(reader: ProtoReader): SendInteractionWithRegionsRequest {
        ...
        return SendInteractionWithRegionsRequest(
      ...
      override fun redact(`value`: SendInteractionWithRegionsRequest):
          SendInteractionWithRegionsRequest = value.copy(
