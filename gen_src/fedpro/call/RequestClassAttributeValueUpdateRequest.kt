...
// Source: fedpro.RequestClassAttributeValueUpdateRequest in RtiAmbassador.proto
package fedpro.call
...
public class RequestClassAttributeValueUpdateRequest(
  @field:WireField(
    tag = 1,
...
) : Message<RequestClassAttributeValueUpdateRequest, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is RequestClassAttributeValueUpdateRequest) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "RequestClassAttributeValueUpdateRequest{", separator =
        ", ", postfix = "}")
  }
  ...
  ): RequestClassAttributeValueUpdateRequest = RequestClassAttributeValueUpdateRequest(theClass,
      theAttributes, userSuppliedTag, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<RequestClassAttributeValueUpdateRequest> = object :
        ProtoAdapter<RequestClassAttributeValueUpdateRequest>(
      FieldEncoding.LENGTH_DELIMITED, 
      RequestClassAttributeValueUpdateRequest::class, 
      "type.googleapis.com/fedpro.RequestClassAttributeValueUpdateRequest", 
      PROTO_3, 
      null, 
      "RtiAmbassador.proto"
    ) {
      override fun encodedSize(`value`: RequestClassAttributeValueUpdateRequest): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: RequestClassAttributeValueUpdateRequest) {
      ...
      override fun decode(reader: ProtoReader): RequestClassAttributeValueUpdateRequest {
        ...
        return RequestClassAttributeValueUpdateRequest(
          theClass = theClass,
      ...
      override fun redact(`value`: RequestClassAttributeValueUpdateRequest):
          RequestClassAttributeValueUpdateRequest = value.copy(
