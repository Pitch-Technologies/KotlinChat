...
// Source: fedpro.ConfirmDivestitureRequest in RtiAmbassador.proto
package fedpro.call
...
public class ConfirmDivestitureRequest(
  @field:WireField(
    tag = 1,
...
) : Message<ConfirmDivestitureRequest, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is ConfirmDivestitureRequest) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "ConfirmDivestitureRequest{", separator = ", ", postfix =
        "}")
  }
  ...
  ): ConfirmDivestitureRequest = ConfirmDivestitureRequest(theObject, theAttributes,
      userSuppliedTag, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<ConfirmDivestitureRequest> = object :
        ProtoAdapter<ConfirmDivestitureRequest>(
      FieldEncoding.LENGTH_DELIMITED, 
      ConfirmDivestitureRequest::class, 
      "type.googleapis.com/fedpro.ConfirmDivestitureRequest", 
      PROTO_3, 
      null, 
      "RtiAmbassador.proto"
    ) {
      override fun encodedSize(`value`: ConfirmDivestitureRequest): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: ConfirmDivestitureRequest) {
      ...
      override fun encode(writer: ReverseProtoWriter, `value`: ConfirmDivestitureRequest) {
        writer.writeBytes(value.unknownFields)
        if (value.userSuppliedTag != ByteString.EMPTY) ProtoAdapter.BYTES.encodeWithTag(writer, 3,
            value.userSuppliedTag)
        if (value.theAttributes != null) AttributeHandleSet.ADAPTER.encodeWithTag(writer, 2,
      ...
      override fun decode(reader: ProtoReader): ConfirmDivestitureRequest {
        ...
        return ConfirmDivestitureRequest(
          theObject = theObject,
      ...
      override fun redact(`value`: ConfirmDivestitureRequest): ConfirmDivestitureRequest =
          value.copy(
