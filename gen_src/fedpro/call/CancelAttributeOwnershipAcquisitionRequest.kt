...
// Source: fedpro.CancelAttributeOwnershipAcquisitionRequest in RtiAmbassador.proto
package fedpro.call
...
public class CancelAttributeOwnershipAcquisitionRequest(
  @field:WireField(
    tag = 1,
...
) : Message<CancelAttributeOwnershipAcquisitionRequest, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is CancelAttributeOwnershipAcquisitionRequest) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "CancelAttributeOwnershipAcquisitionRequest{", separator =
        ", ", postfix = "}")
  }
  ...
  public fun copy(
    ...
    unknownFields: ByteString = this.unknownFields,
      ...
      CancelAttributeOwnershipAcquisitionRequest(theObject, theAttributes, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<CancelAttributeOwnershipAcquisitionRequest> = object :
        ProtoAdapter<CancelAttributeOwnershipAcquisitionRequest>(
      FieldEncoding.LENGTH_DELIMITED, 
      CancelAttributeOwnershipAcquisitionRequest::class, 
      "type.googleapis.com/fedpro.CancelAttributeOwnershipAcquisitionRequest", 
      PROTO_3, 
      null, 
      "RtiAmbassador.proto"
    ) {
      override fun encodedSize(`value`: CancelAttributeOwnershipAcquisitionRequest): Int {
      ...
      override fun decode(reader: ProtoReader): CancelAttributeOwnershipAcquisitionRequest {
        ...
        return CancelAttributeOwnershipAcquisitionRequest(
          theObject = theObject,
      ...
      override fun redact(`value`: CancelAttributeOwnershipAcquisitionRequest):
          CancelAttributeOwnershipAcquisitionRequest = value.copy(
