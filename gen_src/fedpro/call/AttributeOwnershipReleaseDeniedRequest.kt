...
// Source: fedpro.AttributeOwnershipReleaseDeniedRequest in RtiAmbassador.proto
package fedpro.call
...
public class AttributeOwnershipReleaseDeniedRequest(
  @field:WireField(
    tag = 1,
...
) : Message<AttributeOwnershipReleaseDeniedRequest, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is AttributeOwnershipReleaseDeniedRequest) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "AttributeOwnershipReleaseDeniedRequest{", separator = ", ",
        postfix = "}")
  }
  ...
  ): AttributeOwnershipReleaseDeniedRequest = AttributeOwnershipReleaseDeniedRequest(theObject,
      theAttributes, userSuppliedTag, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<AttributeOwnershipReleaseDeniedRequest> = object :
        ProtoAdapter<AttributeOwnershipReleaseDeniedRequest>(
      FieldEncoding.LENGTH_DELIMITED, 
      AttributeOwnershipReleaseDeniedRequest::class, 
      "type.googleapis.com/fedpro.AttributeOwnershipReleaseDeniedRequest", 
      PROTO_3, 
      null, 
      "RtiAmbassador.proto"
    ) {
      override fun encodedSize(`value`: AttributeOwnershipReleaseDeniedRequest): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: AttributeOwnershipReleaseDeniedRequest) {
      ...
      override fun decode(reader: ProtoReader): AttributeOwnershipReleaseDeniedRequest {
        ...
        return AttributeOwnershipReleaseDeniedRequest(
          theObject = theObject,
      ...
      override fun redact(`value`: AttributeOwnershipReleaseDeniedRequest):
          AttributeOwnershipReleaseDeniedRequest = value.copy(
