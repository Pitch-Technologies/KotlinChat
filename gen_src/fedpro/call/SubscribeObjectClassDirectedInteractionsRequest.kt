...
// Source: fedpro.SubscribeObjectClassDirectedInteractionsRequest in RtiAmbassador.proto
package fedpro.call
...
public class SubscribeObjectClassDirectedInteractionsRequest(
  @field:WireField(
    tag = 1,
...
) : Message<SubscribeObjectClassDirectedInteractionsRequest, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is SubscribeObjectClassDirectedInteractionsRequest) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "SubscribeObjectClassDirectedInteractionsRequest{",
        separator = ", ", postfix = "}")
  }
  ...
  public fun copy(
    ...
    unknownFields: ByteString = this.unknownFields,
      ...
      SubscribeObjectClassDirectedInteractionsRequest(theClass, interactionList, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<SubscribeObjectClassDirectedInteractionsRequest> = object :
        ProtoAdapter<SubscribeObjectClassDirectedInteractionsRequest>(
      FieldEncoding.LENGTH_DELIMITED, 
      SubscribeObjectClassDirectedInteractionsRequest::class, 
      "type.googleapis.com/fedpro.SubscribeObjectClassDirectedInteractionsRequest", 
      PROTO_3, 
      null, 
      "RtiAmbassador.proto"
    ) {
      override fun encodedSize(`value`: SubscribeObjectClassDirectedInteractionsRequest): Int {
      ...
      override fun decode(reader: ProtoReader): SubscribeObjectClassDirectedInteractionsRequest {
        ...
        return SubscribeObjectClassDirectedInteractionsRequest(
          theClass = theClass,
      ...
      override fun redact(`value`: SubscribeObjectClassDirectedInteractionsRequest):
          SubscribeObjectClassDirectedInteractionsRequest = value.copy(
