...
// Source: fedpro.IsAttributeOwnedByFederateRequest in RtiAmbassador.proto
package fedpro.call
...
public class IsAttributeOwnedByFederateRequest(
  @field:WireField(
    tag = 1,
...
) : Message<IsAttributeOwnedByFederateRequest, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is IsAttributeOwnedByFederateRequest) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "IsAttributeOwnedByFederateRequest{", separator = ", ",
        postfix = "}")
  }
  ...
  ): IsAttributeOwnedByFederateRequest = IsAttributeOwnedByFederateRequest(theObject, theAttribute,
      unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<IsAttributeOwnedByFederateRequest> = object :
        ProtoAdapter<IsAttributeOwnedByFederateRequest>(
      FieldEncoding.LENGTH_DELIMITED, 
      IsAttributeOwnedByFederateRequest::class, 
      "type.googleapis.com/fedpro.IsAttributeOwnedByFederateRequest", 
      PROTO_3, 
      null, 
      "RtiAmbassador.proto"
    ) {
      override fun encodedSize(`value`: IsAttributeOwnedByFederateRequest): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: IsAttributeOwnedByFederateRequest) {
      ...
      override fun encode(writer: ReverseProtoWriter, `value`: IsAttributeOwnedByFederateRequest) {
        writer.writeBytes(value.unknownFields)
        if (value.theAttribute != null) AttributeHandle.ADAPTER.encodeWithTag(writer, 2,
            value.theAttribute)
        if (value.theObject != null) ObjectInstanceHandle.ADAPTER.encodeWithTag(writer, 1,
      ...
      override fun decode(reader: ProtoReader): IsAttributeOwnedByFederateRequest {
        ...
        return IsAttributeOwnedByFederateRequest(
          theObject = theObject,
      ...
      override fun redact(`value`: IsAttributeOwnedByFederateRequest):
          IsAttributeOwnedByFederateRequest = value.copy(
