...
// Source: fedpro.SubscribeObjectClassAttributesPassivelyRequest in RtiAmbassador.proto
package fedpro.call
...
public class SubscribeObjectClassAttributesPassivelyRequest(
  @field:WireField(
    tag = 1,
...
) : Message<SubscribeObjectClassAttributesPassivelyRequest, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is SubscribeObjectClassAttributesPassivelyRequest) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "SubscribeObjectClassAttributesPassivelyRequest{", separator
        = ", ", postfix = "}")
  }
  ...
  public fun copy(
    ...
    unknownFields: ByteString = this.unknownFields,
      ...
      SubscribeObjectClassAttributesPassivelyRequest(theClass, attributeList, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<SubscribeObjectClassAttributesPassivelyRequest> = object :
        ProtoAdapter<SubscribeObjectClassAttributesPassivelyRequest>(
      FieldEncoding.LENGTH_DELIMITED, 
      SubscribeObjectClassAttributesPassivelyRequest::class, 
      "type.googleapis.com/fedpro.SubscribeObjectClassAttributesPassivelyRequest", 
      PROTO_3, 
      null, 
      "RtiAmbassador.proto"
    ) {
      override fun encodedSize(`value`: SubscribeObjectClassAttributesPassivelyRequest): Int {
      ...
      override fun decode(reader: ProtoReader): SubscribeObjectClassAttributesPassivelyRequest {
        ...
        return SubscribeObjectClassAttributesPassivelyRequest(
          theClass = theClass,
      ...
      override fun redact(`value`: SubscribeObjectClassAttributesPassivelyRequest):
          SubscribeObjectClassAttributesPassivelyRequest = value.copy(
