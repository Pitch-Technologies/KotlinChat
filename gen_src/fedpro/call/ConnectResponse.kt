...
// Source: fedpro.ConnectResponse in RtiAmbassador.proto
package fedpro.call
...
public class ConnectResponse(
...
) : Message<ConnectResponse, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is ConnectResponse) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "ConnectResponse{", separator = ", ", postfix = "}")
  }

  public fun copy(configurationResult: ConfigurationResult? = this.configurationResult,
      unknownFields: ByteString = this.unknownFields): ConnectResponse =
      ConnectResponse(configurationResult, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<ConnectResponse> = object : ProtoAdapter<ConnectResponse>(
      FieldEncoding.LENGTH_DELIMITED, 
      ConnectResponse::class, 
      "type.googleapis.com/fedpro.ConnectResponse", 
      PROTO_3, 
      null, 
      "RtiAmbassador.proto"
    ) {
      override fun encodedSize(`value`: ConnectResponse): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: ConnectResponse) {
        if (value.configurationResult != null) ConfigurationResult.ADAPTER.encodeWithTag(writer, 1,
            value.configurationResult)
        writer.writeBytes(value.unknownFields)
      }

      override fun encode(writer: ReverseProtoWriter, `value`: ConnectResponse) {
        writer.writeBytes(value.unknownFields)
        if (value.configurationResult != null) ConfigurationResult.ADAPTER.encodeWithTag(writer, 1,
            value.configurationResult)
      }

      override fun decode(reader: ProtoReader): ConnectResponse {
      ...
      override fun redact(`value`: ConnectResponse): ConnectResponse = value.copy(
