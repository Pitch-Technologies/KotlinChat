...
// Source: fedpro.RequestInstanceAttributeValueUpdateRequest in RtiAmbassador.proto
package fedpro.call
...
public class RequestInstanceAttributeValueUpdateRequest(
  @field:WireField(
    tag = 1,
...
) : Message<RequestInstanceAttributeValueUpdateRequest, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is RequestInstanceAttributeValueUpdateRequest) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "RequestInstanceAttributeValueUpdateRequest{", separator =
        ", ", postfix = "}")
  }
  ...
  public fun copy(
    ...
    unknownFields: ByteString = this.unknownFields,
      ...
      RequestInstanceAttributeValueUpdateRequest(theObject, theAttributes, userSuppliedTag,
      unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<RequestInstanceAttributeValueUpdateRequest> = object :
        ProtoAdapter<RequestInstanceAttributeValueUpdateRequest>(
      FieldEncoding.LENGTH_DELIMITED, 
      RequestInstanceAttributeValueUpdateRequest::class, 
      "type.googleapis.com/fedpro.RequestInstanceAttributeValueUpdateRequest", 
      PROTO_3, 
      null, 
      "RtiAmbassador.proto"
    ) {
      override fun encodedSize(`value`: RequestInstanceAttributeValueUpdateRequest): Int {
      ...
      override fun decode(reader: ProtoReader): RequestInstanceAttributeValueUpdateRequest {
        ...
        return RequestInstanceAttributeValueUpdateRequest(
          theObject = theObject,
      ...
      override fun redact(`value`: RequestInstanceAttributeValueUpdateRequest):
          RequestInstanceAttributeValueUpdateRequest = value.copy(
