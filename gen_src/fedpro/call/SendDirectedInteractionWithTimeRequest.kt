...
// Source: fedpro.SendDirectedInteractionWithTimeRequest in RtiAmbassador.proto
package fedpro.call
...
public class SendDirectedInteractionWithTimeRequest(
  @field:WireField(
    tag = 1,
...
) : Message<SendDirectedInteractionWithTimeRequest, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is SendDirectedInteractionWithTimeRequest) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "SendDirectedInteractionWithTimeRequest{", separator = ", ",
        postfix = "}")
  }
  ...
  ): SendDirectedInteractionWithTimeRequest = SendDirectedInteractionWithTimeRequest(theInteraction,
      theObject, theParameters, userSuppliedTag, theTime, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<SendDirectedInteractionWithTimeRequest> = object :
        ProtoAdapter<SendDirectedInteractionWithTimeRequest>(
      FieldEncoding.LENGTH_DELIMITED, 
      SendDirectedInteractionWithTimeRequest::class, 
      "type.googleapis.com/fedpro.SendDirectedInteractionWithTimeRequest", 
      PROTO_3, 
      null, 
      "RtiAmbassador.proto"
    ) {
      override fun encodedSize(`value`: SendDirectedInteractionWithTimeRequest): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: SendDirectedInteractionWithTimeRequest) {
      ...
      override fun decode(reader: ProtoReader): SendDirectedInteractionWithTimeRequest {
        ...
        return SendDirectedInteractionWithTimeRequest(
      ...
      override fun redact(`value`: SendDirectedInteractionWithTimeRequest):
          SendDirectedInteractionWithTimeRequest = value.copy(
