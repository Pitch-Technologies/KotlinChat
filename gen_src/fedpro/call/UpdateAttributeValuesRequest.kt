...
// Source: fedpro.UpdateAttributeValuesRequest in RtiAmbassador.proto
package fedpro.call
...
public class UpdateAttributeValuesRequest(
  @field:WireField(
    tag = 1,
...
) : Message<UpdateAttributeValuesRequest, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is UpdateAttributeValuesRequest) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "UpdateAttributeValuesRequest{", separator = ", ", postfix =
        "}")
  }
  ...
  ): UpdateAttributeValuesRequest = UpdateAttributeValuesRequest(theObject, theAttributes,
      userSuppliedTag, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<UpdateAttributeValuesRequest> = object :
        ProtoAdapter<UpdateAttributeValuesRequest>(
      FieldEncoding.LENGTH_DELIMITED, 
      UpdateAttributeValuesRequest::class, 
      "type.googleapis.com/fedpro.UpdateAttributeValuesRequest", 
      PROTO_3, 
      null, 
      "RtiAmbassador.proto"
    ) {
      override fun encodedSize(`value`: UpdateAttributeValuesRequest): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: UpdateAttributeValuesRequest) {
      ...
      override fun encode(writer: ReverseProtoWriter, `value`: UpdateAttributeValuesRequest) {
        writer.writeBytes(value.unknownFields)
        if (value.userSuppliedTag != ByteString.EMPTY) ProtoAdapter.BYTES.encodeWithTag(writer, 3,
            value.userSuppliedTag)
        if (value.theAttributes != null) AttributeHandleValueMap.ADAPTER.encodeWithTag(writer, 2,
      ...
      override fun decode(reader: ProtoReader): UpdateAttributeValuesRequest {
        ...
        return UpdateAttributeValuesRequest(
          theObject = theObject,
      ...
      override fun redact(`value`: UpdateAttributeValuesRequest): UpdateAttributeValuesRequest =
          value.copy(
