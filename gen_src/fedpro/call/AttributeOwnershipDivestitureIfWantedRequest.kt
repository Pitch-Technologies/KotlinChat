...
// Source: fedpro.AttributeOwnershipDivestitureIfWantedRequest in RtiAmbassador.proto
package fedpro.call
...
public class AttributeOwnershipDivestitureIfWantedRequest(
  @field:WireField(
    tag = 1,
...
) : Message<AttributeOwnershipDivestitureIfWantedRequest, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is AttributeOwnershipDivestitureIfWantedRequest) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "AttributeOwnershipDivestitureIfWantedRequest{", separator =
        ", ", postfix = "}")
  }
  ...
  public fun copy(
    ...
    unknownFields: ByteString = this.unknownFields,
      ...
      AttributeOwnershipDivestitureIfWantedRequest(theObject, theAttributes, userSuppliedTag,
      unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<AttributeOwnershipDivestitureIfWantedRequest> = object :
        ProtoAdapter<AttributeOwnershipDivestitureIfWantedRequest>(
      FieldEncoding.LENGTH_DELIMITED, 
      AttributeOwnershipDivestitureIfWantedRequest::class, 
      "type.googleapis.com/fedpro.AttributeOwnershipDivestitureIfWantedRequest", 
      PROTO_3, 
      null, 
      "RtiAmbassador.proto"
    ) {
      override fun encodedSize(`value`: AttributeOwnershipDivestitureIfWantedRequest): Int {
      ...
      override fun decode(reader: ProtoReader): AttributeOwnershipDivestitureIfWantedRequest {
        ...
        return AttributeOwnershipDivestitureIfWantedRequest(
          theObject = theObject,
      ...
      override fun redact(`value`: AttributeOwnershipDivestitureIfWantedRequest):
          AttributeOwnershipDivestitureIfWantedRequest = value.copy(
