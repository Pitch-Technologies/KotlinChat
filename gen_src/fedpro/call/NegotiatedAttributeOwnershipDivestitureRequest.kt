...
// Source: fedpro.NegotiatedAttributeOwnershipDivestitureRequest in RtiAmbassador.proto
package fedpro.call
...
public class NegotiatedAttributeOwnershipDivestitureRequest(
  @field:WireField(
    tag = 1,
...
) : Message<NegotiatedAttributeOwnershipDivestitureRequest, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is NegotiatedAttributeOwnershipDivestitureRequest) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "NegotiatedAttributeOwnershipDivestitureRequest{", separator
        = ", ", postfix = "}")
  }
  ...
  public fun copy(
    ...
    unknownFields: ByteString = this.unknownFields,
      ...
      NegotiatedAttributeOwnershipDivestitureRequest(theObject, theAttributes, userSuppliedTag,
      unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<NegotiatedAttributeOwnershipDivestitureRequest> = object :
        ProtoAdapter<NegotiatedAttributeOwnershipDivestitureRequest>(
      FieldEncoding.LENGTH_DELIMITED, 
      NegotiatedAttributeOwnershipDivestitureRequest::class, 
      "type.googleapis.com/fedpro.NegotiatedAttributeOwnershipDivestitureRequest", 
      PROTO_3, 
      null, 
      "RtiAmbassador.proto"
    ) {
      override fun encodedSize(`value`: NegotiatedAttributeOwnershipDivestitureRequest): Int {
      ...
      override fun decode(reader: ProtoReader): NegotiatedAttributeOwnershipDivestitureRequest {
        ...
        return NegotiatedAttributeOwnershipDivestitureRequest(
          theObject = theObject,
      ...
      override fun redact(`value`: NegotiatedAttributeOwnershipDivestitureRequest):
          NegotiatedAttributeOwnershipDivestitureRequest = value.copy(
