...
// Source: fedpro.RegisterFederationSynchronizationPointRequest in RtiAmbassador.proto
package fedpro.call
...
public class RegisterFederationSynchronizationPointRequest(
  @field:WireField(
    tag = 1,
...
) : Message<RegisterFederationSynchronizationPointRequest, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is RegisterFederationSynchronizationPointRequest) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "RegisterFederationSynchronizationPointRequest{", separator
        = ", ", postfix = "}")
  }
  ...
  public fun copy(
    ...
    unknownFields: ByteString = this.unknownFields,
      ...
      RegisterFederationSynchronizationPointRequest(synchronizationPointLabel, userSuppliedTag,
      unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<RegisterFederationSynchronizationPointRequest> = object :
        ProtoAdapter<RegisterFederationSynchronizationPointRequest>(
      FieldEncoding.LENGTH_DELIMITED, 
      RegisterFederationSynchronizationPointRequest::class, 
      "type.googleapis.com/fedpro.RegisterFederationSynchronizationPointRequest", 
      PROTO_3, 
      null, 
      "RtiAmbassador.proto"
    ) {
      override fun encodedSize(`value`: RegisterFederationSynchronizationPointRequest): Int {
      ...
      override fun decode(reader: ProtoReader): RegisterFederationSynchronizationPointRequest {
        ...
        return RegisterFederationSynchronizationPointRequest(
      ...
      override fun redact(`value`: RegisterFederationSynchronizationPointRequest):
          RegisterFederationSynchronizationPointRequest = value.copy(
