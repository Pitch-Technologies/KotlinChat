...
// Source: fedpro.QueryAttributeOwnershipRequest in RtiAmbassador.proto
package fedpro.call
...
public class QueryAttributeOwnershipRequest(
  @field:WireField(
    tag = 1,
...
) : Message<QueryAttributeOwnershipRequest, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is QueryAttributeOwnershipRequest) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "QueryAttributeOwnershipRequest{", separator = ", ", postfix
        = "}")
  }
  ...
  ): QueryAttributeOwnershipRequest = QueryAttributeOwnershipRequest(theObject, theAttributes,
      unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<QueryAttributeOwnershipRequest> = object :
        ProtoAdapter<QueryAttributeOwnershipRequest>(
      FieldEncoding.LENGTH_DELIMITED, 
      QueryAttributeOwnershipRequest::class, 
      "type.googleapis.com/fedpro.QueryAttributeOwnershipRequest", 
      PROTO_3, 
      null, 
      "RtiAmbassador.proto"
    ) {
      override fun encodedSize(`value`: QueryAttributeOwnershipRequest): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: QueryAttributeOwnershipRequest) {
      ...
      override fun encode(writer: ReverseProtoWriter, `value`: QueryAttributeOwnershipRequest) {
        writer.writeBytes(value.unknownFields)
        if (value.theAttributes != null) AttributeHandleSet.ADAPTER.encodeWithTag(writer, 2,
            value.theAttributes)
        if (value.theObject != null) ObjectInstanceHandle.ADAPTER.encodeWithTag(writer, 1,
      ...
      override fun decode(reader: ProtoReader): QueryAttributeOwnershipRequest {
        ...
        return QueryAttributeOwnershipRequest(
          theObject = theObject,
      ...
      override fun redact(`value`: QueryAttributeOwnershipRequest): QueryAttributeOwnershipRequest =
          value.copy(
