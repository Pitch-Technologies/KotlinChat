...
// Source: fedpro.AttributesInScope in FederateAmbassador.proto
...
public class AttributesInScope(
...
) : Message<AttributesInScope, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is AttributesInScope) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "AttributesInScope{", separator = ", ", postfix = "}")
  }
  ...
  ): AttributesInScope = AttributesInScope(theObject, theAttributes, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<AttributesInScope> = object : ProtoAdapter<AttributesInScope>(
      FieldEncoding.LENGTH_DELIMITED, 
      AttributesInScope::class, 
      "type.googleapis.com/fedpro.AttributesInScope", 
      PROTO_3, 
      null, 
      "FederateAmbassador.proto"
    ) {
      override fun encodedSize(`value`: AttributesInScope): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: AttributesInScope) {
      ...
      override fun encode(writer: ReverseProtoWriter, `value`: AttributesInScope) {
        writer.writeBytes(value.unknownFields)
        if (value.theAttributes != null) AttributeHandleSet.ADAPTER.encodeWithTag(writer, 2,
            value.theAttributes)
        if (value.theObject != null) ObjectInstanceHandle.ADAPTER.encodeWithTag(writer, 1,
      ...
      override fun decode(reader: ProtoReader): AttributesInScope {
      ...
      override fun redact(`value`: AttributesInScope): AttributesInScope = value.copy(
