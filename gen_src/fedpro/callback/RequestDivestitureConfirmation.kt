...
// Source: fedpro.RequestDivestitureConfirmation in FederateAmbassador.proto
...
public class RequestDivestitureConfirmation(
...
) : Message<RequestDivestitureConfirmation, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is RequestDivestitureConfirmation) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "RequestDivestitureConfirmation{", separator = ", ", postfix
        = "}")
  }
  ...
  ): RequestDivestitureConfirmation = RequestDivestitureConfirmation(theObject, offeredAttributes,
      userSuppliedTag, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<RequestDivestitureConfirmation> = object :
        ProtoAdapter<RequestDivestitureConfirmation>(
      FieldEncoding.LENGTH_DELIMITED, 
      RequestDivestitureConfirmation::class, 
      "type.googleapis.com/fedpro.RequestDivestitureConfirmation", 
      PROTO_3, 
      null, 
      "FederateAmbassador.proto"
    ) {
      override fun encodedSize(`value`: RequestDivestitureConfirmation): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: RequestDivestitureConfirmation) {
      ...
      override fun encode(writer: ReverseProtoWriter, `value`: RequestDivestitureConfirmation) {
        writer.writeBytes(value.unknownFields)
        if (value.userSuppliedTag != ByteString.EMPTY) ProtoAdapter.BYTES.encodeWithTag(writer, 3,
            value.userSuppliedTag)
        if (value.offeredAttributes != null) AttributeHandleSet.ADAPTER.encodeWithTag(writer, 2,
      ...
      override fun decode(reader: ProtoReader): RequestDivestitureConfirmation {
      ...
      override fun redact(`value`: RequestDivestitureConfirmation): RequestDivestitureConfirmation =
          value.copy(
