...
// Source: fedpro.ConfirmAttributeTransportationTypeChange in FederateAmbassador.proto
...
public class ConfirmAttributeTransportationTypeChange(
  @field:WireField(
    tag = 1,
...
) : Message<ConfirmAttributeTransportationTypeChange, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is ConfirmAttributeTransportationTypeChange) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "ConfirmAttributeTransportationTypeChange{", separator =
        ", ", postfix = "}")
  }
  ...
  ): ConfirmAttributeTransportationTypeChange = ConfirmAttributeTransportationTypeChange(theObject,
      theAttributes, theTransportation, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<ConfirmAttributeTransportationTypeChange> = object :
        ProtoAdapter<ConfirmAttributeTransportationTypeChange>(
      FieldEncoding.LENGTH_DELIMITED, 
      ConfirmAttributeTransportationTypeChange::class, 
      "type.googleapis.com/fedpro.ConfirmAttributeTransportationTypeChange", 
      PROTO_3, 
      null, 
      "FederateAmbassador.proto"
    ) {
      override fun encodedSize(`value`: ConfirmAttributeTransportationTypeChange): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: ConfirmAttributeTransportationTypeChange) {
      ...
      override fun decode(reader: ProtoReader): ConfirmAttributeTransportationTypeChange {
      ...
      override fun redact(`value`: ConfirmAttributeTransportationTypeChange):
          ConfirmAttributeTransportationTypeChange = value.copy(
