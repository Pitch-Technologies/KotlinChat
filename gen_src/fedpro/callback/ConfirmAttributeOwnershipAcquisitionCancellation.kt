...
// Source: fedpro.ConfirmAttributeOwnershipAcquisitionCancellation in FederateAmbassador.proto
...
public class ConfirmAttributeOwnershipAcquisitionCancellation(
...
) : Message<ConfirmAttributeOwnershipAcquisitionCancellation, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is ConfirmAttributeOwnershipAcquisitionCancellation) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "ConfirmAttributeOwnershipAcquisitionCancellation{",
        separator = ", ", postfix = "}")
  }
  ...
  public fun copy(
    ...
    unknownFields: ByteString = this.unknownFields,
      ...
      ConfirmAttributeOwnershipAcquisitionCancellation(theObject, theAttributes, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<ConfirmAttributeOwnershipAcquisitionCancellation> = object :
        ProtoAdapter<ConfirmAttributeOwnershipAcquisitionCancellation>(
      FieldEncoding.LENGTH_DELIMITED, 
      ConfirmAttributeOwnershipAcquisitionCancellation::class, 
      "type.googleapis.com/fedpro.ConfirmAttributeOwnershipAcquisitionCancellation", 
      PROTO_3, 
      null, 
      "FederateAmbassador.proto"
    ) {
      override fun encodedSize(`value`: ConfirmAttributeOwnershipAcquisitionCancellation): Int {
      ...
      override fun decode(reader: ProtoReader): ConfirmAttributeOwnershipAcquisitionCancellation {
      ...
      override fun redact(`value`: ConfirmAttributeOwnershipAcquisitionCancellation):
          ConfirmAttributeOwnershipAcquisitionCancellation = value.copy(
