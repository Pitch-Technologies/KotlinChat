...
// Source: fedpro.ReceiveInteractionWithRetraction in FederateAmbassador.proto
...
public class ReceiveInteractionWithRetraction(
  @field:WireField(
    tag = 1,
...
) : Message<ReceiveInteractionWithRetraction, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is ReceiveInteractionWithRetraction) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "ReceiveInteractionWithRetraction{", separator = ", ",
        postfix = "}")
  }
  ...
  ): ReceiveInteractionWithRetraction = ReceiveInteractionWithRetraction(interactionClass,
      theParameters, userSuppliedTag, sentOrdering, theTransport, theTime, receivedOrdering,
      retractionHandle, receiveInfo, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<ReceiveInteractionWithRetraction> = object :
        ProtoAdapter<ReceiveInteractionWithRetraction>(
      FieldEncoding.LENGTH_DELIMITED, 
      ReceiveInteractionWithRetraction::class, 
      "type.googleapis.com/fedpro.ReceiveInteractionWithRetraction", 
      PROTO_3, 
      null, 
      "FederateAmbassador.proto"
    ) {
      override fun encodedSize(`value`: ReceiveInteractionWithRetraction): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: ReceiveInteractionWithRetraction) {
      ...
      override fun encode(writer: ReverseProtoWriter, `value`: ReceiveInteractionWithRetraction) {
        writer.writeBytes(value.unknownFields)
        if (value.receiveInfo != null) SupplementalReceiveInfo.ADAPTER.encodeWithTag(writer, 9,
            value.receiveInfo)
        if (value.retractionHandle != null) MessageRetractionHandle.ADAPTER.encodeWithTag(writer, 8,
      ...
      override fun decode(reader: ProtoReader): ReceiveInteractionWithRetraction {
        ...
        return ReceiveInteractionWithRetraction(
      ...
      override fun redact(`value`: ReceiveInteractionWithRetraction):
          ReceiveInteractionWithRetraction = value.copy(
