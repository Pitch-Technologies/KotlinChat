...
// Source: fedpro.AttributeOwnershipUnavailable in FederateAmbassador.proto
...
public class AttributeOwnershipUnavailable(
...
) : Message<AttributeOwnershipUnavailable, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is AttributeOwnershipUnavailable) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "AttributeOwnershipUnavailable{", separator = ", ", postfix
        = "}")
  }
  ...
  ): AttributeOwnershipUnavailable = AttributeOwnershipUnavailable(theObject, theAttributes,
      userSuppliedTag, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<AttributeOwnershipUnavailable> = object :
        ProtoAdapter<AttributeOwnershipUnavailable>(
      FieldEncoding.LENGTH_DELIMITED, 
      AttributeOwnershipUnavailable::class, 
      "type.googleapis.com/fedpro.AttributeOwnershipUnavailable", 
      PROTO_3, 
      null, 
      "FederateAmbassador.proto"
    ) {
      override fun encodedSize(`value`: AttributeOwnershipUnavailable): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: AttributeOwnershipUnavailable) {
      ...
      override fun encode(writer: ReverseProtoWriter, `value`: AttributeOwnershipUnavailable) {
        writer.writeBytes(value.unknownFields)
        if (value.userSuppliedTag != ByteString.EMPTY) ProtoAdapter.BYTES.encodeWithTag(writer, 3,
            value.userSuppliedTag)
        if (value.theAttributes != null) AttributeHandleSet.ADAPTER.encodeWithTag(writer, 2,
      ...
      override fun decode(reader: ProtoReader): AttributeOwnershipUnavailable {
      ...
      override fun redact(`value`: AttributeOwnershipUnavailable): AttributeOwnershipUnavailable =
          value.copy(
