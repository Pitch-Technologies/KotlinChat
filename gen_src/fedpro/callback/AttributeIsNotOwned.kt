...
// Source: fedpro.AttributeIsNotOwned in FederateAmbassador.proto
...
public class AttributeIsNotOwned(
...
) : Message<AttributeIsNotOwned, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is AttributeIsNotOwned) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "AttributeIsNotOwned{", separator = ", ", postfix = "}")
  }
  ...
  ): AttributeIsNotOwned = AttributeIsNotOwned(theObject, theAttributes, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<AttributeIsNotOwned> = object :
        ProtoAdapter<AttributeIsNotOwned>(
      FieldEncoding.LENGTH_DELIMITED, 
      AttributeIsNotOwned::class, 
      "type.googleapis.com/fedpro.AttributeIsNotOwned", 
      PROTO_3, 
      null, 
      "FederateAmbassador.proto"
    ) {
      override fun encodedSize(`value`: AttributeIsNotOwned): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: AttributeIsNotOwned) {
      ...
      override fun encode(writer: ReverseProtoWriter, `value`: AttributeIsNotOwned) {
        writer.writeBytes(value.unknownFields)
        if (value.theAttributes != null) AttributeHandleSet.ADAPTER.encodeWithTag(writer, 2,
            value.theAttributes)
        if (value.theObject != null) ObjectInstanceHandle.ADAPTER.encodeWithTag(writer, 1,
      ...
      override fun decode(reader: ProtoReader): AttributeIsNotOwned {
      ...
      override fun redact(`value`: AttributeIsNotOwned): AttributeIsNotOwned = value.copy(
