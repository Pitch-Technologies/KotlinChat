...
// Source: fedpro.ReflectAttributeValues in FederateAmbassador.proto
...
public class ReflectAttributeValues(
...
) : Message<ReflectAttributeValues, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is ReflectAttributeValues) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "ReflectAttributeValues{", separator = ", ", postfix = "}")
  }
  ...
  ): ReflectAttributeValues = ReflectAttributeValues(theObject, theAttributes, userSuppliedTag,
      sentOrdering, theTransport, reflectInfo, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<ReflectAttributeValues> = object :
        ProtoAdapter<ReflectAttributeValues>(
      FieldEncoding.LENGTH_DELIMITED, 
      ReflectAttributeValues::class, 
      "type.googleapis.com/fedpro.ReflectAttributeValues", 
      PROTO_3, 
      null, 
      "FederateAmbassador.proto"
    ) {
      override fun encodedSize(`value`: ReflectAttributeValues): Int {
        ...
        if (value.reflectInfo != null) size += SupplementalReflectInfo.ADAPTER.encodedSizeWithTag(6,
            value.reflectInfo)
        return size
      }

      override fun encode(writer: ProtoWriter, `value`: ReflectAttributeValues) {
        ...
        if (value.theTransport != null) TransportationTypeHandle.ADAPTER.encodeWithTag(writer, 5,
            value.theTransport)
        if (value.reflectInfo != null) SupplementalReflectInfo.ADAPTER.encodeWithTag(writer, 6,
            value.reflectInfo)
        writer.writeBytes(value.unknownFields)
      }

      override fun encode(writer: ReverseProtoWriter, `value`: ReflectAttributeValues) {
        writer.writeBytes(value.unknownFields)
        if (value.reflectInfo != null) SupplementalReflectInfo.ADAPTER.encodeWithTag(writer, 6,
            value.reflectInfo)
        if (value.theTransport != null) TransportationTypeHandle.ADAPTER.encodeWithTag(writer, 5,
      ...
      override fun decode(reader: ProtoReader): ReflectAttributeValues {
        ...
        val unknownFields = reader.forEachTag { tag ->
          when (tag) {
            ...
            6 -> reflectInfo = SupplementalReflectInfo.ADAPTER.decode(reader)
      ...
      override fun redact(`value`: ReflectAttributeValues): ReflectAttributeValues = value.copy(
