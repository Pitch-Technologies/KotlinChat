...
// Source: fedpro.ReceiveDirectedInteractionWithTime in FederateAmbassador.proto
...
public class ReceiveDirectedInteractionWithTime(
  @field:WireField(
    tag = 1,
...
) : Message<ReceiveDirectedInteractionWithTime, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is ReceiveDirectedInteractionWithTime) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "ReceiveDirectedInteractionWithTime{", separator = ", ",
        postfix = "}")
  }
  ...
  ): ReceiveDirectedInteractionWithTime = ReceiveDirectedInteractionWithTime(interactionClass,
      theObject, theParameters, userSuppliedTag, sentOrdering, theTransport, theTime,
      receivedOrdering, receiveInfo, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<ReceiveDirectedInteractionWithTime> = object :
        ProtoAdapter<ReceiveDirectedInteractionWithTime>(
      FieldEncoding.LENGTH_DELIMITED, 
      ReceiveDirectedInteractionWithTime::class, 
      "type.googleapis.com/fedpro.ReceiveDirectedInteractionWithTime", 
      PROTO_3, 
      null, 
      "FederateAmbassador.proto"
    ) {
      override fun encodedSize(`value`: ReceiveDirectedInteractionWithTime): Int {
        ...
        if (value.receiveInfo != null) size += SupplementalReceiveInfo.ADAPTER.encodedSizeWithTag(9,
            value.receiveInfo)
        return size
      }

      override fun encode(writer: ProtoWriter, `value`: ReceiveDirectedInteractionWithTime) {
        ...
        if (value.receiveInfo != null) SupplementalReceiveInfo.ADAPTER.encodeWithTag(writer, 9,
            value.receiveInfo)
        writer.writeBytes(value.unknownFields)
      }

      override fun encode(writer: ReverseProtoWriter, `value`: ReceiveDirectedInteractionWithTime) {
        writer.writeBytes(value.unknownFields)
        if (value.receiveInfo != null) SupplementalReceiveInfo.ADAPTER.encodeWithTag(writer, 9,
            value.receiveInfo)
        if (value.receivedOrdering != OrderType.RECEIVE) OrderType.ADAPTER.encodeWithTag(writer, 8,
      ...
      override fun decode(reader: ProtoReader): ReceiveDirectedInteractionWithTime {
        ...
        val unknownFields = reader.forEachTag { tag ->
          when (tag) {
            ...
            9 -> receiveInfo = SupplementalReceiveInfo.ADAPTER.decode(reader)
            else -> reader.readUnknownField(tag)
          }
        }
        return ReceiveDirectedInteractionWithTime(
      ...
      override fun redact(`value`: ReceiveDirectedInteractionWithTime):
          ReceiveDirectedInteractionWithTime = value.copy(
