...
// Source: fedpro.ProvideAttributeValueUpdate in FederateAmbassador.proto
...
public class ProvideAttributeValueUpdate(
...
) : Message<ProvideAttributeValueUpdate, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is ProvideAttributeValueUpdate) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "ProvideAttributeValueUpdate{", separator = ", ", postfix =
        "}")
  }
  ...
  ): ProvideAttributeValueUpdate = ProvideAttributeValueUpdate(theObject, theAttributes,
      userSuppliedTag, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<ProvideAttributeValueUpdate> = object :
        ProtoAdapter<ProvideAttributeValueUpdate>(
      FieldEncoding.LENGTH_DELIMITED, 
      ProvideAttributeValueUpdate::class, 
      "type.googleapis.com/fedpro.ProvideAttributeValueUpdate", 
      PROTO_3, 
      null, 
      "FederateAmbassador.proto"
    ) {
      override fun encodedSize(`value`: ProvideAttributeValueUpdate): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: ProvideAttributeValueUpdate) {
      ...
      override fun encode(writer: ReverseProtoWriter, `value`: ProvideAttributeValueUpdate) {
        writer.writeBytes(value.unknownFields)
        if (value.userSuppliedTag != ByteString.EMPTY) ProtoAdapter.BYTES.encodeWithTag(writer, 3,
            value.userSuppliedTag)
        if (value.theAttributes != null) AttributeHandleSet.ADAPTER.encodeWithTag(writer, 2,
      ...
      override fun decode(reader: ProtoReader): ProvideAttributeValueUpdate {
      ...
      override fun redact(`value`: ProvideAttributeValueUpdate): ProvideAttributeValueUpdate =
          value.copy(
