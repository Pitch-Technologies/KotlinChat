...
// Source: fedpro.ReceiveInteraction in FederateAmbassador.proto
...
public class ReceiveInteraction(
...
) : Message<ReceiveInteraction, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is ReceiveInteraction) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "ReceiveInteraction{", separator = ", ", postfix = "}")
  }
  ...
  ): ReceiveInteraction = ReceiveInteraction(interactionClass, theParameters, userSuppliedTag,
      sentOrdering, theTransport, receiveInfo, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<ReceiveInteraction> = object :
        ProtoAdapter<ReceiveInteraction>(
      FieldEncoding.LENGTH_DELIMITED, 
      ReceiveInteraction::class, 
      "type.googleapis.com/fedpro.ReceiveInteraction", 
      PROTO_3, 
      null, 
      "FederateAmbassador.proto"
    ) {
      override fun encodedSize(`value`: ReceiveInteraction): Int {
        ...
        if (value.receiveInfo != null) size += SupplementalReceiveInfo.ADAPTER.encodedSizeWithTag(6,
            value.receiveInfo)
        return size
      }

      override fun encode(writer: ProtoWriter, `value`: ReceiveInteraction) {
        ...
        if (value.theTransport != null) TransportationTypeHandle.ADAPTER.encodeWithTag(writer, 5,
            value.theTransport)
        if (value.receiveInfo != null) SupplementalReceiveInfo.ADAPTER.encodeWithTag(writer, 6,
            value.receiveInfo)
        writer.writeBytes(value.unknownFields)
      }

      override fun encode(writer: ReverseProtoWriter, `value`: ReceiveInteraction) {
        writer.writeBytes(value.unknownFields)
        if (value.receiveInfo != null) SupplementalReceiveInfo.ADAPTER.encodeWithTag(writer, 6,
            value.receiveInfo)
        if (value.theTransport != null) TransportationTypeHandle.ADAPTER.encodeWithTag(writer, 5,
      ...
      override fun decode(reader: ProtoReader): ReceiveInteraction {
        ...
        val unknownFields = reader.forEachTag { tag ->
          when (tag) {
            ...
            6 -> receiveInfo = SupplementalReceiveInfo.ADAPTER.decode(reader)
      ...
      override fun redact(`value`: ReceiveInteraction): ReceiveInteraction = value.copy(
