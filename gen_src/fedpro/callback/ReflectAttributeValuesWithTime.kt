...
// Source: fedpro.ReflectAttributeValuesWithTime in FederateAmbassador.proto
...
public class ReflectAttributeValuesWithTime(
  @field:WireField(
    tag = 1,
...
) : Message<ReflectAttributeValuesWithTime, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is ReflectAttributeValuesWithTime) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "ReflectAttributeValuesWithTime{", separator = ", ", postfix
        = "}")
  }
  ...
  ): ReflectAttributeValuesWithTime = ReflectAttributeValuesWithTime(theObject, theAttributes,
      userSuppliedTag, sentOrdering, theTransport, theTime, receivedOrdering, reflectInfo,
      unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<ReflectAttributeValuesWithTime> = object :
        ProtoAdapter<ReflectAttributeValuesWithTime>(
      FieldEncoding.LENGTH_DELIMITED, 
      ReflectAttributeValuesWithTime::class, 
      "type.googleapis.com/fedpro.ReflectAttributeValuesWithTime", 
      PROTO_3, 
      null, 
      "FederateAmbassador.proto"
    ) {
      override fun encodedSize(`value`: ReflectAttributeValuesWithTime): Int {
        ...
        if (value.reflectInfo != null) size += SupplementalReflectInfo.ADAPTER.encodedSizeWithTag(8,
            value.reflectInfo)
        return size
      }

      override fun encode(writer: ProtoWriter, `value`: ReflectAttributeValuesWithTime) {
        ...
        if (value.reflectInfo != null) SupplementalReflectInfo.ADAPTER.encodeWithTag(writer, 8,
            value.reflectInfo)
        writer.writeBytes(value.unknownFields)
      }

      override fun encode(writer: ReverseProtoWriter, `value`: ReflectAttributeValuesWithTime) {
        writer.writeBytes(value.unknownFields)
        if (value.reflectInfo != null) SupplementalReflectInfo.ADAPTER.encodeWithTag(writer, 8,
            value.reflectInfo)
        if (value.receivedOrdering != OrderType.RECEIVE) OrderType.ADAPTER.encodeWithTag(writer, 7,
      ...
      override fun decode(reader: ProtoReader): ReflectAttributeValuesWithTime {
        ...
        val unknownFields = reader.forEachTag { tag ->
          when (tag) {
            ...
            8 -> reflectInfo = SupplementalReflectInfo.ADAPTER.decode(reader)
            else -> reader.readUnknownField(tag)
          }
        }
        return ReflectAttributeValuesWithTime(
          theObject = theObject,
      ...
      override fun redact(`value`: ReflectAttributeValuesWithTime): ReflectAttributeValuesWithTime =
          value.copy(
