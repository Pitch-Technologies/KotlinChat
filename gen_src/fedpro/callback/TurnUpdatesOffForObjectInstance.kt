...
// Source: fedpro.TurnUpdatesOffForObjectInstance in FederateAmbassador.proto
...
public class TurnUpdatesOffForObjectInstance(
...
) : Message<TurnUpdatesOffForObjectInstance, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is TurnUpdatesOffForObjectInstance) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "TurnUpdatesOffForObjectInstance{", separator = ", ",
        postfix = "}")
  }
  ...
  ): TurnUpdatesOffForObjectInstance = TurnUpdatesOffForObjectInstance(theObject, theAttributes,
      unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<TurnUpdatesOffForObjectInstance> = object :
        ProtoAdapter<TurnUpdatesOffForObjectInstance>(
      FieldEncoding.LENGTH_DELIMITED, 
      TurnUpdatesOffForObjectInstance::class, 
      "type.googleapis.com/fedpro.TurnUpdatesOffForObjectInstance", 
      PROTO_3, 
      null, 
      "FederateAmbassador.proto"
    ) {
      override fun encodedSize(`value`: TurnUpdatesOffForObjectInstance): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: TurnUpdatesOffForObjectInstance) {
      ...
      override fun encode(writer: ReverseProtoWriter, `value`: TurnUpdatesOffForObjectInstance) {
        writer.writeBytes(value.unknownFields)
        if (value.theAttributes != null) AttributeHandleSet.ADAPTER.encodeWithTag(writer, 2,
            value.theAttributes)
        if (value.theObject != null) ObjectInstanceHandle.ADAPTER.encodeWithTag(writer, 1,
      ...
      override fun decode(reader: ProtoReader): TurnUpdatesOffForObjectInstance {
      ...
      override fun redact(`value`: TurnUpdatesOffForObjectInstance): TurnUpdatesOffForObjectInstance
          = value.copy(
