...
// Source: fedpro.RemoveObjectInstanceWithRetraction in FederateAmbassador.proto
...
public class RemoveObjectInstanceWithRetraction(
  @field:WireField(
    tag = 1,
...
) : Message<RemoveObjectInstanceWithRetraction, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is RemoveObjectInstanceWithRetraction) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "RemoveObjectInstanceWithRetraction{", separator = ", ",
        postfix = "}")
  }
  ...
  ): RemoveObjectInstanceWithRetraction = RemoveObjectInstanceWithRetraction(theObject,
      userSuppliedTag, sentOrdering, theTime, receivedOrdering, retractionHandle, producingFederate,
      unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<RemoveObjectInstanceWithRetraction> = object :
        ProtoAdapter<RemoveObjectInstanceWithRetraction>(
      FieldEncoding.LENGTH_DELIMITED, 
      RemoveObjectInstanceWithRetraction::class, 
      "type.googleapis.com/fedpro.RemoveObjectInstanceWithRetraction", 
      PROTO_3, 
      null, 
      "FederateAmbassador.proto"
    ) {
      override fun encodedSize(`value`: RemoveObjectInstanceWithRetraction): Int {
        ...
        if (value.retractionHandle != null) size +=
            MessageRetractionHandle.ADAPTER.encodedSizeWithTag(6, value.retractionHandle)
        if (value.producingFederate != null) size += FederateHandle.ADAPTER.encodedSizeWithTag(7,
            value.producingFederate)
        return size
      }

      override fun encode(writer: ProtoWriter, `value`: RemoveObjectInstanceWithRetraction) {
        ...
        if (value.retractionHandle != null) MessageRetractionHandle.ADAPTER.encodeWithTag(writer, 6,
            value.retractionHandle)
        if (value.producingFederate != null) FederateHandle.ADAPTER.encodeWithTag(writer, 7,
            value.producingFederate)
        writer.writeBytes(value.unknownFields)
      }

      override fun encode(writer: ReverseProtoWriter, `value`: RemoveObjectInstanceWithRetraction) {
        writer.writeBytes(value.unknownFields)
        if (value.producingFederate != null) FederateHandle.ADAPTER.encodeWithTag(writer, 7,
            value.producingFederate)
        if (value.retractionHandle != null) MessageRetractionHandle.ADAPTER.encodeWithTag(writer, 6,
      ...
      override fun decode(reader: ProtoReader): RemoveObjectInstanceWithRetraction {
        ...
        val unknownFields = reader.forEachTag { tag ->
          when (tag) {
            ...
            6 -> retractionHandle = MessageRetractionHandle.ADAPTER.decode(reader)
            7 -> producingFederate = FederateHandle.ADAPTER.decode(reader)
            else -> reader.readUnknownField(tag)
          }
        }
        return RemoveObjectInstanceWithRetraction(
          theObject = theObject,
      ...
      override fun redact(`value`: RemoveObjectInstanceWithRetraction):
          RemoveObjectInstanceWithRetraction = value.copy(
