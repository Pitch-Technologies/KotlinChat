...
// Source: fedpro.TurnUpdatesOnForObjectInstance in FederateAmbassador.proto
...
public class TurnUpdatesOnForObjectInstance(
...
) : Message<TurnUpdatesOnForObjectInstance, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is TurnUpdatesOnForObjectInstance) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "TurnUpdatesOnForObjectInstance{", separator = ", ", postfix
        = "}")
  }
  ...
  ): TurnUpdatesOnForObjectInstance = TurnUpdatesOnForObjectInstance(theObject, theAttributes,
      unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<TurnUpdatesOnForObjectInstance> = object :
        ProtoAdapter<TurnUpdatesOnForObjectInstance>(
      FieldEncoding.LENGTH_DELIMITED, 
      TurnUpdatesOnForObjectInstance::class, 
      "type.googleapis.com/fedpro.TurnUpdatesOnForObjectInstance", 
      PROTO_3, 
      null, 
      "FederateAmbassador.proto"
    ) {
      override fun encodedSize(`value`: TurnUpdatesOnForObjectInstance): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: TurnUpdatesOnForObjectInstance) {
      ...
      override fun encode(writer: ReverseProtoWriter, `value`: TurnUpdatesOnForObjectInstance) {
        writer.writeBytes(value.unknownFields)
        if (value.theAttributes != null) AttributeHandleSet.ADAPTER.encodeWithTag(writer, 2,
            value.theAttributes)
        if (value.theObject != null) ObjectInstanceHandle.ADAPTER.encodeWithTag(writer, 1,
      ...
      override fun decode(reader: ProtoReader): TurnUpdatesOnForObjectInstance {
      ...
      override fun redact(`value`: TurnUpdatesOnForObjectInstance): TurnUpdatesOnForObjectInstance =
          value.copy(
