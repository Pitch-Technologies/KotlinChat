...
// Source: fedpro.AttributeIsOwnedByRTI in FederateAmbassador.proto
...
public class AttributeIsOwnedByRTI(
...
) : Message<AttributeIsOwnedByRTI, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is AttributeIsOwnedByRTI) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "AttributeIsOwnedByRTI{", separator = ", ", postfix = "}")
  }
  ...
  ): AttributeIsOwnedByRTI = AttributeIsOwnedByRTI(theObject, theAttributes, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<AttributeIsOwnedByRTI> = object :
        ProtoAdapter<AttributeIsOwnedByRTI>(
      FieldEncoding.LENGTH_DELIMITED, 
      AttributeIsOwnedByRTI::class, 
      "type.googleapis.com/fedpro.AttributeIsOwnedByRTI", 
      PROTO_3, 
      null, 
      "FederateAmbassador.proto"
    ) {
      override fun encodedSize(`value`: AttributeIsOwnedByRTI): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: AttributeIsOwnedByRTI) {
      ...
      override fun encode(writer: ReverseProtoWriter, `value`: AttributeIsOwnedByRTI) {
        writer.writeBytes(value.unknownFields)
        if (value.theAttributes != null) AttributeHandleSet.ADAPTER.encodeWithTag(writer, 2,
            value.theAttributes)
        if (value.theObject != null) ObjectInstanceHandle.ADAPTER.encodeWithTag(writer, 1,
      ...
      override fun decode(reader: ProtoReader): AttributeIsOwnedByRTI {
      ...
      override fun redact(`value`: AttributeIsOwnedByRTI): AttributeIsOwnedByRTI = value.copy(
